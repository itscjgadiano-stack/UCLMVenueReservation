...
<div class="auth-card">
    ...
    <?php if($success): ?>
        <div style="background-color: #ECFDF5; color: #059669; padding: 0.875rem; border-radius: var(--radius-md); margin-bottom: 1.5rem; border: 1px solid #A7F3D0; font-size: 0.9rem; display: flex; gap: 0.5rem; align-items: center;">
            <i class="fa-solid fa-circle-check"></i> 
            <div>
                <?= htmlspecialchars($success) ?> <a href="login.php" style="text-decoration: underline; font-weight: 600; color: #047857;">Login here</a>
            </div>
        </div>
    <?php endif; ?>
